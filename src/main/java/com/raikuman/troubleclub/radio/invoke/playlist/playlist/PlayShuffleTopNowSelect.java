...
import com.raikuman.troubleclub.radio.music.playerhandler.playlist.PlayShuffleTopPlaylistHandler;
import com.raikuman.troubleclub.radio.music.playlist.Playlist;
import net.dv8tion.jda.api.events.interaction.component.StringSelectInteractionEvent;

public class PlayShuffleTopNowSelect extends SelectComponent {
    ...
    public void handle(StringSelectInteractionEvent ctx) {
        ...
        MusicManager.getInstance().play(new PlayShuffleTopPlaylistHandler(
            ctx,
            playlist,
            true));
    ...
    public String getInvoke() {
        return "playlistplayshuffletopnowselect";
    }

    @Override
    public String displayLabel() {
        return "Shuffle to Top and Play Now";
    }
}
