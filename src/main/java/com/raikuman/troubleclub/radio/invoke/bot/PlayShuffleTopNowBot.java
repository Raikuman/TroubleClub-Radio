...
public class PlayShuffleTopNowBot extends Command {
    ...
    public void handle(CommandContext ctx) {
        ...
        MusicManager.getInstance().play(new PlayShuffleTopHandler(ctx.event(), link, true));
    }

    @Override
    public String getInvoke() {
        return "playshuffletopnowbot";
    }
