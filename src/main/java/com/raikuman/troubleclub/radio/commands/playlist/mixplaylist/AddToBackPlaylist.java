 ...
 * the end of the first playlist
 *
 * @version 1.0 2023-27-07
 * @since 1.3
 */
public class AddToBackPlaylist implements SelectInterface {
    ...
    public void handle(SelectContext ctx) {
        ...
        descriptionBuilder
            .append("Successfully mixed these cassettes via add to end:\n\n**")
    ...
    public String displayLabel() {
        return "Add to the end of the cassette";
    }

    @Override
    public String getInvoke() {
        return "addtobackplaylist";
    }
}
