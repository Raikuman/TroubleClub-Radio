...
/**
 * Handles mixing two playlists using a user's playlist and another user's playlist by shuffling them together
 *
 * @version 1.0 2023-27-07
 * @since 1.3
 */
public class ShuffleToPlaylist implements SelectInterface {
    ...
    public void handle(SelectContext ctx) {
        ...
        descriptionBuilder
            .append("Successfully mixed these cassettes via shuffle:\n\n**")
    ...
    public String displayLabel() {
        return "Shuffle to cassette";
    }

    @Override
    public String getInvoke() {
        return "shuffletoplaylist";
    }
}
