...
/**
 * Handles showing the description of track commands
 *
 * @version 1.2 2022-15-07
 * @since 1.1
 */
public class TrackSelect implements SelectInterface, PageInvokeInterface {

	private final List<CommandInterface> commands;

	public TrackSelect(List<CommandInterface> commands) {
		this.commands = HelpResources.parseCategory(commands, new TrackCategory());
	}
